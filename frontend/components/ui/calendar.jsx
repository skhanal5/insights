  ...
  return (
    (<DayPicker
      ...
      classNames={{
        ...
        day_selected:
          "bg-blue-600 text-slate-50 hover:bg-blue-500 hover:text-slate-700 focus:bg-blue-600 focus:text-slate-50",
        day_today: "bg-slate-200 text-slate-900 dark:bg-slate-800 dark:text-slate-50",
        day_outside:
